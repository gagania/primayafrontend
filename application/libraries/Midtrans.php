...
class Midtrans {
    ...
    public static function getSnapToken($params) {
        ...
        $result = Midtrans::post(
                        Midtrans::getSnapBaseUrl() . '/transactions', Midtrans::$serverKey, $params);
    ...
    public static function status($id) {
        return Midtrans::get(
                        Midtrans::getBaseUrl() . '/' . $id . '/status', Midtrans::$serverKey, false);
    }
    ...
    public static function approve($id) {
        return Midtrans::post(
                        Midtrans::getBaseUrl() . '/' . $id . '/approve', Midtrans::$serverKey, false)->status_code;
    }
    ...
    public static function cancel($id) {
        return Midtrans::post(
                        Midtrans::getBaseUrl() . '/' . $id . '/cancel', Midtrans::$serverKey, false)->status_code;
    }
    ...
    public static function expire($id) {
        return Midtrans::post(
                        Midtrans::getBaseUrl() . '/' . $id . '/expire', Midtrans::$serverKey, false);
    }
